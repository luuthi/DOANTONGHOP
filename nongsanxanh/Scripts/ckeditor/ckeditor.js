...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "GAGE", version: "4.6.0", revision: "5877d8b", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var d = CKEDITOR.event.prototype, b; for (b in d) null == a[b] && (a[b] = d[b]) }, CKEDITOR.event.prototype = function () {
        ...
        return {
            ...
            once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                var a = 0, b = function () { a = 1 }, g = 0, h = function () { g = 1 }; return function (l, m, r) {
                    var f = d(this)[l]; l = a; var D = g; a = g = 0; if (f) {
                        var t = f.listeners; if (t.length) for (var t = t.slice(0), z, x = 0; x < t.length; x++) {
                            if (f.errorProof) try {
                                z =
                                t[x].call(this, r, m, b, h)
                            } catch (p) { } else z = t[x].call(this, r, m, b, h); !1 === z ? g = 1 : "undefined" != typeof z && (m = z); if (a || g) break
                        }
                    } m = g ? !1 : "undefined" == typeof m ? !0 : m; a = l; g = D; return m
                }
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, l = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, m = function (a, f) { return "#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : l[f] }; CKEDITOR.on("reset", function () { a = [] }); CKEDITOR.tools = {
            ...
            }, extend: function (a) { var f = arguments.length, b, c; "boolean" == typeof (b = arguments[f - 1]) ? f-- : "boolean" == typeof (b = arguments[f - 2]) && (c = arguments[f - 1], f -= 2); for (var l = 1; l < f; l++) { var d = arguments[l], p; for (p in d) if (!0 === b || null == a[p]) if (!c || p in c) a[p] = d[p] } return a }, prototypedCopy: function (a) { var f = function () { }; f.prototype = a; return new f }, copy: function (a) { var f = {}, b; for (b in a) f[b] = a[b]; return f }, isArray: function (a) { return "[object Array]" == Object.prototype.toString.call(a) },
            ...
            }, htmlEncode: function (a) { return void 0 === a || null === a ? "" : String(a).replace(b, "\x26amp;").replace(c, "\x26gt;").replace(e, "\x26lt;") }, htmlDecode: function (a) { return a.replace(h, m) }, htmlEncodeAttr: function (a) { return CKEDITOR.tools.htmlEncode(a).replace(g, "\x26quot;") }, htmlDecodeAttr: function (a) { return CKEDITOR.tools.htmlDecode(a) },
            ...
            genKey: function () { return Array.prototype.slice.call(arguments).join("-") }, defer: function (a) { return function () { var f = arguments, b = this; window.setTimeout(function () { a.apply(b, f) }, 0) } }, normalizeCssText: function (a, f) { var b = [], c, l = CKEDITOR.tools.parseCssText(a, !0, f); for (c in l) b.push(c + ":" + l[c]); b.sort(); return b.length ? b.join(";") + ";" : "" }, convertRgbToHex: function (a) {
                ...
                function (a, c, p) { b && (c = c.toLowerCase(), "font-family" == c && (p = p.replace(/\s*,\s*/g, ",")), p = CKEDITOR.tools.trim(p)); l[c] = p }); return l
            ...
            b) { for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), l = c.length, d; l--;) d = a.createElement(c[l]), b && a.appendChild(d) }, checkIfAnyArrayItemMatches: function (a, b) { for (var c = 0, l = a.length; c < l; ++c) if (a[c].match(b)) return !0; return !1 }, checkIfAnyObjectPropertyMatches: function (a, b) { for (var c in a) if (c.match(b)) return !0; return !1 }, keystrokeToString: function (a, b) {
                var c = b & 16711680, l =
                b & 65535, d = CKEDITOR.env.mac, m = [], p = []; c & CKEDITOR.CTRL && (m.push(d ? "⌘" : a[17]), p.push(d ? a[224] : a[17])); c & CKEDITOR.ALT && (m.push(d ? "⌥" : a[18]), p.push(a[18])); c & CKEDITOR.SHIFT && (m.push(d ? "⇧" : a[16]), p.push(a[16])); l && (a[l] ? (m.push(a[l]), p.push(a[l])) : (m.push(String.fromCharCode(l)), p.push(String.fromCharCode(l)))); return { display: m.join("+"), aria: p.join("+") }
                ...
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, l, d = 0; d < b.length; d++) if (c = b[d].split("\x3d"), l = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), l === a) return decodeURIComponent(1 < c.length ? c[1] : ""); return null
                ...
                var a = CKEDITOR.tools.getCookie("ckCsrfToken"); if (!a || 40 != a.length) {
                    ...
                    else for (var c = 0; 40 > c; c++) a.push(Math.floor(256 * Math.random())); for (c = 0; c < a.length; c++) var l = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36), b = b + (.5 < Math.random() ? l.toUpperCase() : l); a = b; CKEDITOR.tools.setCookie("ckCsrfToken", a)
                } return a
    ...
    CKEDITOR.dtd = function () {
        ...
        a(b, { a: 1, abbr: 1, area: 1, audio: 1, b: 1, bdi: 1, bdo: 1, br: 1, button: 1, canvas: 1, cite: 1, code: 1, command: 1, datalist: 1, del: 1, dfn: 1, em: 1, embed: 1, i: 1, iframe: 1, img: 1, input: 1, ins: 1, kbd: 1, keygen: 1, label: 1, map: 1, mark: 1, meter: 1, noscript: 1, object: 1, output: 1, progress: 1, q: 1, ruby: 1, s: 1, samp: 1, script: 1, select: 1, small: 1, span: 1, strong: 1, sub: 1, sup: 1, textarea: 1, time: 1, u: 1, "var": 1, video: 1, wbr: 1 }, l, { acronym: 1, applet: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1 }); a(c, e, b, m); d = {
            ...
            $block: a({ audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1 }, e, m), $blockLimit: {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) { if (this.$.createStyleSheet) this.$.createStyleSheet(a); else { var d = new CKEDITOR.dom.element("link"); d.setAttributes({ rel: "stylesheet", type: "text/css", href: a }); this.getHead().append(d) } }, appendStyleText: function (a) {
            ...
            for (var b =
            this.$.documentElement, c = 0; b && c < a.length; c++) { var e = a[c]; if (d) for (var g = -1, h = 0; h < b.childNodes.length; h++) { var l = b.childNodes[h]; if (!0 !== d || 3 != l.nodeType || !l.previousSibling || 3 != l.previousSibling.nodeType) if (g++, g == e) { b = l; break } } else b = b.childNodes[e] } return b ? new CKEDITOR.dom.node(b) : null
        ...
        null !== String(e.add).match(/\[Native code\]/gi), g = /[\n\t\r]/g; CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++) if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                ...
                var b = this.$.style; if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    var c = ["top", "left", "right", "bottom"], f; "border" == a && (f = ["color", "style", "width"]); for (var b = [], d = 0; d < c.length; d++) if (f) for (var t =
                    0; t < f.length; t++) b.push([a, c[d], f[t]].join("-")); else b.push([a, c[d]].join("-")); for (a = 0; a < b.length; a++) this.removeStyle(b[a])
                }
                ...
                var b = 0, c = 0, f = this.getDocument(), d = f.getBody(), t = "BackCompat" == f.$.compatMode; if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var f, d = c.startContainer; f = c.endContainer; var e = c.startOffset, D = c.endOffset, u, k = this.guard, q = this.type, n = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var y = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), g = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(D) : f.getNext(); this._.guardLTR = function (a, b) {
                    return (!b || !y.equals(a)) && (!g ||
                    !a.equals(g)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
        ...
        function (a) { return function (b) { b = g(b) || h(b) || l(b); return !!(a ^ b) } }; var r = CKEDITOR.dom.walker.ignored(); CKEDITOR.dom.walker.empty = function (a) { return function (b) { for (var c = 0, f = b.getChildCount() ; c < f; ++c) if (!r(b.getChild(c))) return !!a; return !a } }; var f = CKEDITOR.dom.walker.empty(), D = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) { var b = {}, c; for (c in a) CKEDITOR.dtd[c]["#"] && (b[c] = 1); return b }(CKEDITOR.dtd.$block), { caption: 1, td: 1, th: 1 }); CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b =
                r(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(D) && f(b)) ? !0 : !1; return !!(a ^ b)
            }
        }; CKEDITOR.dom.element.prototype.getBogus = function () { var a = this; do a = a.getPreviousSourceNode(); while (m(a)); return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && e.test(a.getText())) ? a : !1 }
    })();
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, e) {
            function p(a, b, c, f) { var d = c ? a.getPrevious() : a.getNext(); if (f && l) return d; k || f ? b.append(a.clone(!0, e), c) : (a.remove(), u && b.append(a)); return d } function g() { var a, b, c, f = Math.min(O.length, B.length); for (a = 0; a < f; a++) if (b = O[a], c = B[a], !b.equals(c)) return a; return a - 1 } function h() {
                var b = I - 1, c = C && r && !q.equals(n); b < E - 1 || b < K - 1 || c ? (c ? a.moveToPosition(n,
            ...
            } a.optimizeBookmark(); var l = 0 === b, u = 1 == b, k = 2 == b; b = k || u; var q = a.startContainer, n = a.endContainer,
            y = a.startOffset, A = a.endOffset, J, G, C, r, m, P; if (k && n.type == CKEDITOR.NODE_TEXT && q.equals(n)) q = a.document.createText(q.substring(y, A)), c.append(q); else {
                n.type == CKEDITOR.NODE_TEXT ? k ? P = !0 : n = n.split(A) : 0 < n.getChildCount() ? A >= n.getChildCount() ? (n = n.getChild(A - 1), G = !0) : n = n.getChild(A) : r = G = !0; q.type == CKEDITOR.NODE_TEXT ? k ? m = !0 : q.split(y) : 0 < q.getChildCount() ? 0 === y ? (q = q.getChild(y), J = !0) : q = q.getChild(y - 1) : C = J = !0; for (var O = q.getParents(), B = n.getParents(), I = g(), E = O.length - 1, K = B.length - 1, F = c, L, aa, V, ga = -1, R = I; R <= E; R++) {
                    aa =
                    O[R]; V = aa.getNext(); for (R != E || aa.equals(B[R]) && E < K ? b && (L = F.append(aa.clone(0, e))) : J ? p(aa, F, !1, C) : m && F.append(a.document.createText(aa.substring(y))) ; V;) { if (V.equals(B[R])) { ga = R; break } V = p(V, F) } F = L
                } F = c; for (R = I; R <= K; R++) if (c = B[R], V = c.getPrevious(), c.equals(O[R])) b && (F = F.getChild(0)); else { R != K || c.equals(O[R]) && K < E ? b && (L = F.append(c.clone(0, e))) : G ? p(c, F, !1, r) : P && F.append(a.document.createText(c.substring(0, A))); if (R > ga) for (; V;) V = p(V, F, !0); F = L } k || h()
            }
        } function b() {
        ...
        } var g = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, h = CKEDITOR.dom.walker.bogus(), l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, m = CKEDITOR.dom.walker.editable(), r = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b, c, d, e, p = this.collapsed; b = this.document.createElement("span"); b.data("cke-bookmark", 1); b.setStyle("display", "none"); b.setHtml("\x26nbsp;"); a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(), b.setAttribute("id", d + (p ? "C" : "S"))); p || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), e = this.clone(),
                e.collapse(), e.insertNode(c)); e = this.clone(); e.collapse(!0); e.insertNode(b); c ? (this.setStartAfter(b), this.setEndBefore(c)) : this.moveToPosition(b, CKEDITOR.POSITION_AFTER_END); return { startNode: a ? d + (p ? "C" : "S") : b, endNode: a ? d + "E" : c, serializable: a, collapsed: p }
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } var d = new RegExp(/[^\s\ufeff]/); switch (a) {
                    case CKEDITOR.ENLARGE_INLINE: var e = 1; case CKEDITOR.ENLARGE_ELEMENT: var p = function (a, b) {
                        ...
                        c.next() ;) { if (f.type != CKEDITOR.NODE_TEXT) return !1; J = f != a ? f.getText() : f.substring(b); if (d.test(J)) return !1 } return !0
                    }; if (this.collapsed) break; var g = this.getCommonAncestor(), h = this.root, l, u, k, q, n, y = !1, A, J; A = this.startContainer; var G = this.startOffset; A.type == CKEDITOR.NODE_TEXT ? (G && (A = !CKEDITOR.tools.trim(A.substring(0, G)).length && A, y = !!A), A && ((q = A.getPrevious()) || (k = A.getParent()))) : (G && (q = A.getChild(G - 1) || A.getLast()), q || (k = A)); for (k = c(k) ; k || q;) {
                        if (k && !q) {
                            !n && k.equals(g) && (n = !0); if (e ? k.isBlockBoundary() :
                            !h.contains(k)) break; y && "inline" == k.getComputedStyle("display") || (y = !1, n ? l = k : this.setStartBefore(k)); q = k.getPrevious()
                            ...
                            if (q.type == CKEDITOR.NODE_TEXT) J = q.getText(), d.test(J) && (q = null), A = /[\s\ufeff]$/.test(J); else if ((q.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && q.is("br")) && !q.data("cke-bookmark")) if (y && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                J = q.getText(); if (d.test(J)) q = null; else for (var G = q.$.getElementsByTagName("*"), C = 0, r; r =
                                G[C++];) if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) { q = null; break } q && (A = !!J.length)
                            } else q = null; A && (y ? n ? l = k : k && this.setStartBefore(k) : y = !0); if (q) { A = q.getPrevious(); if (!k && !A) { k = q; q = null; break } q = A } else k = null
                        } k && (k = c(k.getParent()))
                    } A = this.endContainer; G = this.endOffset; k = q = null; n = y = !1; A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(G)).length ? y = !0 : (y = !A.getLength(), G == A.getLength() ? (q = A.getNext()) || (k = A.getParent()) : p(A, G) && (k = A.getParent())) : (q = A.getChild(G)) || (k = A); for (; k ||
                    q;) {
                        if (k && !q) { !n && k.equals(g) && (n = !0); if (e ? k.isBlockBoundary() : !h.contains(k)) break; y && "inline" == k.getComputedStyle("display") || (y = !1, n ? u = k : k && this.setEndAfter(k)); q = k.getNext() } for (; q;) {
                            A = !1; if (q.type == CKEDITOR.NODE_TEXT) J = q.getText(), p(q, 0) || (q = null), A = /^[\s\ufeff]/.test(J); else if (q.type == CKEDITOR.NODE_ELEMENT) {
                                if ((0 < q.$.offsetWidth || b && q.is("br")) && !q.data("cke-bookmark")) if (y && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                    J = q.getText(); if (d.test(J)) q = null; else for (G = q.$.getElementsByTagName("*"), C =
                                    0; r = G[C++];) if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) { q = null; break } q && (A = !!J.length)
                                } else q = null
                            } else A = 1; A && y && (n ? u = k : this.setEndAfter(k)); if (q) { A = q.getNext(); if (!k && !A) { k = q; q = null; break } q = A } else k = null
                        } k && (k = c(k.getParent()))
                    } l && u && (g = l.contains(u) ? u : l, this.setStartBefore(g), this.setEndAfter(g)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: k = new CKEDITOR.dom.range(this.root); h = this.root; k.setStartAt(h, CKEDITOR.POSITION_AFTER_START); k.setEnd(this.startContainer,
                    ...
                    CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { k = this.clone(); k = new CKEDITOR.dom.walker(k); var E = CKEDITOR.dom.walker.whitespaces(), K = CKEDITOR.dom.walker.bookmark(); k.evaluator = function (a) { return !E(a) && !K(a) }; if ((k = k.previous()) && k.type == CKEDITOR.NODE_ELEMENT && k.is("br")) break } k = this.clone(); k.collapse(); k.setEndAt(h, CKEDITOR.POSITION_BEFORE_END); k = new CKEDITOR.dom.walker(k); k.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : I; m = B = P = null; k = k.lastForward();
                        m = m || h; this.setEndAt(m, !k && this.checkEndOfBlock() || k && m.contains(k) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); P && this.setEndAfter(P)
                }
            }, shrink: function (a, b, c) {
                if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var d = this.clone(), e = this.startContainer, p = this.endContainer, g = this.startOffset, h = this.endOffset, l = 1, u = 1; e && e.type == CKEDITOR.NODE_TEXT && (g ? g >= e.getLength() ? d.setStartAfter(e) : (d.setStartBefore(e), l = 0) : d.setStartBefore(e)); p && p.type == CKEDITOR.NODE_TEXT && (h ? h >= p.getLength() ? d.setEndAfter(p) :
                    (d.setEndAfter(p), u = 0) : d.setEndBefore(p)); var d = new CKEDITOR.dom.walker(d), k = CKEDITOR.dom.walker.bookmark(); d.evaluator = function (b) { return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT) }; var q; d.guard = function (b, d) {
                        if (k(b)) return !0; if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(q) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1; d || b.type != CKEDITOR.NODE_ELEMENT ||
                        (q = b); return !0
                    }; l && (e = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(e, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START); u && (d.reset(), (d = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(d, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END)); return !(!l && !u)
                }
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, p = d.block, g = null; if (!c.blockLimit.equals(d.blockLimit)) return null; "br" != a && (e || (e = this.fixBlock(!0, a), p = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), p || (p = this.fixBlock(!1, a))); c = e && this.checkStartOfBlock(); d = p && this.checkEndOfBlock(); this.deleteContents(); e && e.equals(p) &&
                (d ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(p, CKEDITOR.POSITION_AFTER_END), p = null) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (p = this.splitElement(e, b || !1), e.is("ul", "ol") || e.appendBogus())); return { previousBlock: e, nextBlock: p, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: g }
                ...
                if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1)) return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START), !0; for (var c = 0; a;) {
                    ...
                    !0; var d = a, e = c, p = void 0; d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (p = d[b ? "getLast" : "getFirst"](r)); e || p || (p = d[b ? "getPrevious" : "getNext"](r)); a = p
                } return !!c
            }, moveToClosestEditablePosition: function (a, b) {
                var c, d = 0, e, p, g = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START]; a ? (c = new CKEDITOR.dom.range(this.root), c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone(); if (a && !a.is(CKEDITOR.dtd.$block)) d = 1; else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]()) d = 1, (p = e.type == CKEDITOR.NODE_ELEMENT) &&
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], p, g, h, l; if (c && c.find) for (g = c.find(a), p = 0; p < g.count() ; p++) if (c = g.getItem(p), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED,
                h && l && e.push(c); return e
            }
        }
    ...
    (function () {
        ...
        l = function (a) { return g(a) && h(a) }, m = { dd: 1, dt: 1, li: 1 }; a.prototype = {
            getNextParagraph: function (a) {
                var d, h, t, z, x; a = a || "p"; if (this._.nestedEditable) {
                    ...
                    var p = this.range.clone(); h = p.startPath(); var w = p.endPath(), H = !p.collapsed && c(p, h.block), v = !p.collapsed && c(p, w.block, 1); p.shrink(CKEDITOR.SHRINK_ELEMENT, !0); H && p.setStartAt(h.block, CKEDITOR.POSITION_BEFORE_END); v && p.setEndAt(w.block, CKEDITOR.POSITION_AFTER_START); h = p.endContainer.hasAscendant("pre", !0) || p.startContainer.hasAscendant("pre", !0); p.enlarge(this.forceBrBreak && !h || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                    ...
                    (w = new CKEDITOR.dom.elementPath(w.endContainer, w.root), this._.lastNode = (w.block || w.blockLimit).getNextSourceNode(!0))), this._.lastNode && p.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = p.document.createText(""), this._.lastNode.insertAfter(h)), p = null); this._.started = 1; h = p
                } w = this._.nextNode; p = this._.lastNode; for (this._.nextNode = null; w;) {
                    var H = 0, v = w.hasAscendant("pre"), u = w.type != CKEDITOR.NODE_ELEMENT, k = 0; if (u) w.type == CKEDITOR.NODE_TEXT && e.test(w.getText()) && (u = 0); else {
                        var q = w.getName();
                        if (CKEDITOR.dtd.$block[q] && "false" == w.getAttribute("contenteditable")) { d = w; b(this, a, d); break } else if (w.isBlockBoundary(this.forceBrBreak && !v && { br: 1 })) { if ("br" == q) u = 1; else if (!h && !w.getChildCount() && "hr" != q) { d = w; t = w.equals(p); break } h && (h.setEndAt(w, CKEDITOR.POSITION_BEFORE_START), "br" != q && (this._.nextNode = w)); H = 1 } else { if (w.getFirst()) { h || (h = this.range.clone(), h.setStartAt(w, CKEDITOR.POSITION_BEFORE_START)); w = w.getFirst(); continue } u = 1 }
                    } u && !h && (h = this.range.clone(), h.setStartAt(w, CKEDITOR.POSITION_BEFORE_START));
                    t = (!H || u) && w.equals(p); if (h && !H) for (; !w.getNext(l) && !t;) { q = w.getParent(); if (q.isBlockBoundary(this.forceBrBreak && !v && { br: 1 })) { H = 1; u = 0; t || q.equals(p); h.setEndAt(q, CKEDITOR.POSITION_BEFORE_END); break } w = q; u = 1; t = w.equals(p); k = 1 } u && h.setEndAt(w, CKEDITOR.POSITION_AFTER_END); w = this._getNextSourceNode(w, k, p); if ((t = !w) || H && h) break
                } if (!d) {
                    if (!h) return this._.docEndMarker && this._.docEndMarker.remove(), this._.nextNode = null; d = new CKEDITOR.dom.elementPath(h.startContainer, h.root); w = d.blockLimit; H = { div: 1, th: 1, td: 1 };
    ...
    (function () {
        function a(a, b, c, d, e) {
            var k, q; a = []; for (k in b) {
                q = b[k]; q = "boolean" == typeof q ? {} : "function" == typeof q ? { match: q } : C(q); "$" != k.charAt(0) && (q.elements = k); c && (q.featureName = c.toLowerCase()); var n = q; n.elements = h(n.elements, /\s+/) || null; n.propertiesOnly = n.propertiesOnly || !0 === n.elements; var f = /\s*,\s*/, p = void 0; for (p in P) {
                    n[p] = h(n[p], f) || null; var E = n, g = O[p], u = h(n[O[p]], f), y = n[p], B = [], A = !0, K = void 0; u ? A = !1 : u = {}; for (K in y) "!" == K.charAt(0) && (K = K.slice(1), B.push(K), u[K] = !0, A = !1); for (; K = B.pop() ;) y[K] =
                    y["!" + K], delete y["!" + K]; E[g] = (A ? !1 : u) || null
                } n.match = n.match || null; d.push(q); a.push(q)
            } b = e.elements; e = e.generic; var G; c = 0; for (d = a.length; c < d; ++c) {
                k = C(a[c]); q = !0 === k.classes || !0 === k.styles || !0 === k.attributes; n = k; p = g = f = void 0; for (f in P) n[f] = H(n[f]); E = !0; for (p in O) { f = O[p]; g = n[f]; u = []; y = void 0; for (y in g) -1 < y.indexOf("*") ? u.push(new RegExp("^" + y.replace(/\*/g, ".*") + "$")) : u.push(y); g = u; g.length && (n[f] = g, E = !1) } n.nothingRequired = E; n.noProperties = !(n.attributes || n.classes || n.styles); if (!0 === k.elements ||
        ...
        b) { if (!a) return !1; var c = !1, d = !0 === a, e; for (e in b) if (d || a(e)) delete b[e], c = !0; return c } function g(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function h(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = Z(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, e; for (e in a) c[e] = a[e], d++; return d ? c : !1 } function l(a, b) {
        ...
        } function f(a) { var b, c, d, e, k = {}, q = 1; for (a = Z(a) ; b = a.match(B) ;) (c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null, k["$" + q++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return k } function D(a, b) { var c = a.match(I[b]); return c ? Z(c[1]) : null } function t(a) {
            ...
            var n = 0, f; k.toHtml && (b.name = b.name.replace(E, "$1")); if (k.doCallbacks && a.elementCallbacks) { a: { f = a.elementCallbacks; for (var g = 0, u = f.length, y; g < u; ++g) if (y = f[g](b)) { f = y; break a } f = void 0 } if (f) return f } if (k.doTransform && (f = a._.transformations[b.name])) { t(b); for (g = 0; g < f.length; ++g) q(a, b, f[g]); p(b) } if (k.doFilter) {
                a: {
                    g = b.name; u = a._; a = u.allowedRules.elements[g]; f = u.allowedRules.generic; g = u.disallowedRules.elements[g]; u = u.disallowedRules.generic;
                    y = k.skipRequired; var h = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 }, B, A; if (a || f) { t(b); if (g) for (B = 0, A = g.length; B < A; ++B) if (!1 === c(g[B], b, h)) { a = null; break a } if (u) for (B = 0, A = u.length; B < A; ++B) c(u[B], b, h); if (a) for (B = 0, A = a.length; B < A; ++B) d(a[B], b, h, y); if (f) for (B = 0, A = f.length; B < A; ++B) d(f[B], b, h, y); a = h } else a = null
                } if (!a || !a.valid) return e.push(b), 1; A = a.validAttributes; var G = a.validStyles;
                ...
                a.hadInvalidClass) { for (F = 0; F < u.length; ++F) (a.allClasses || f[u[F]]) && h.push(u[F]); h.length && (g["class"] = h.sort().join(" ")); y && h.length < y.split(/\s+/).length && (B = !0) } else y && (g["class"] = y); B && (n = 1); if (!k.skipFinalValidation && !w(b)) return e.push(b), 1
            } k.toHtml && (b.name = b.name.replace(K, "cke:$1")); return n
        } function x(a) { var b = [], c; for (c in a) -1 < c.indexOf("*") && b.push(c.replace(/\*/g, ".*")); return b.length ? new RegExp("^(?:" + b.join("|") + ")$") : null } function p(a) {
        ...
        } function w(a) { switch (a.name) { case "a": if (!(a.children.length || a.attributes.name || a.attributes.id)) return !1; break; case "img": if (!a.attributes.src) return !1 } return !0 } function H(a) { if (!a) return !1; if (!0 === a) return !0; var b = x(a); return function (c) { return c in a || b && c.match(b) } } function v() { return new CKEDITOR.htmlParser.element("br") } function u(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
            a.name || G.$block[a.name])
        } function k(a, b, c) {
            var d = a.name; if (G.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (G.$block[d] || "tr" == d) if ("br" == b) a.previous && !u(a.previous) && (b = v(), b.insertBefore(a)), a.next && !u(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e; b: { e = G[b]; for (var k = 0, q = d.length, n; k < q; ++k) if (n = d[k], n.type == CKEDITOR.NODE_ELEMENT && !e[n.name]) { e = !1; break b } e = !0 } if (e) a.name = b, a.attributes =
        ...
        } function q(a, b, c) { var d, e; for (d = 0; d < c.length; ++d) if (e = c[d], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) { e.right(b, F); break } } function n(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, k, q, n, f; if (a.name != c.element) return !1; for (k in d) if ("class" == k) for (c = d[k].split(/\s+/), n = a.classes.join("|") ; f = c.pop() ;) { if (-1 == n.indexOf(f)) return !1 } else if (a.attributes[k] != d[k]) return !1; for (q in e) if (a.styles[q] !=
            e[q]) return !1; return !0
            ...
            !1; this.editor = null; this.id = CKEDITOR.tools.getNextNumber(); this._ = { allowedRules: { elements: {}, generic: [] }, disallowedRules: { elements: {}, generic: [] }, transformations: {}, cachedTests: {} }; CKEDITOR.filter.instances[this.id] = this; if (a instanceof CKEDITOR.editor) {
                a = this.editor = a; this.customConfig = !0; var b = a.config.allowedContent; !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(Q[a.enterMode] + " " + Q[a.shiftEnterMode], "default",
            ...
            allow: function (b, c, d) {
                if (!g(this, b, d)) return !1; var e, k; if ("string" == typeof b) b = f(b); else if (b instanceof CKEDITOR.style) {
                ...
                if (this.disabled) return !1; var e = this, q = [], n = this.editor && this.editor.config.protectedSource, f, g = !1, p = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (f = z(e, a, q, p), f & 1) g = !0; else if (f & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                        var c; a: {
                            var d = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var k, u, E; if (n) for (u = 0; u < n.length; ++u) if ((E = d.match(n[u])) && E[0].length == d.length) {
                                c = !0;
                                break a
                            } d = CKEDITOR.htmlParser.fragment.fromHtml(d); 1 == d.children.length && (k = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, k, c, p); c = !c.length
                        } c || q.push(a)
                    }
                }, null, !0); q.length && (g = !0); var u; a = []; d = Q[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var E; c = q.pop() ;) c.type == CKEDITOR.NODE_ELEMENT ? k(c, d, a) : c.remove(); for (; u = a.pop() ;) if (c = u.el, c.parent) switch (E = G[c.parent.name] || G.span, u.check) {
                    case "it": G.$removeEmpty[c.name] && !c.children.length ? k(c, d, a) : w(c) || k(c, d, a); break; case "el-up": c.parent.type ==
                    CKEDITOR.NODE_DOCUMENT_FRAGMENT || E[c.name] || k(c, d, a); break; case "parent-down": c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || E[c.name] || k(c.parent, d, a)
                } return g
            ...
            addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], e; for (b = 0; b < a.length && !e; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b) d.push(y(a[b], e)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                ...
                var b, c; if (!this.disabled && a) {
                    var d = this._.transformations, e; for (e = 0; e < a.length; ++e) {
                        b = a[e]; var k = void 0, q = void 0, n = void 0, f = void 0, g = void 0, p = void 0; c = []; for (q = 0; q < b.length; ++q) n = b[q], "string" == typeof n ? (n = n.split(/\s*:\s*/), f = n[0], g = null, p = n[1]) : (f = n.check, g = n.left, p = n.right), k || (k = n, k = k.element ? k.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                        k.left.getDefinition().element), g instanceof CKEDITOR.style && (g = A(g)), c.push({ check: f == k ? null : f, left: g, right: "string" == typeof p ? J(p) : p }); b = k; d[b] || (d[b] = []); d[b].push(c)
                    }
                }
            }, check: function (a, b, c) {
                if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var d = a.length; d--;) if (this.check(a[d], b, c)) return !0; return !1 } var e, k; if ("string" == typeof a) {
                    k = a + "\x3c" + (!1 === b ? "0" : "1") + (c ? "1" : "0") + "\x3e"; if (k in this._.cachedChecks) return this._.cachedChecks[k]; d = f(a).$1; e = d.styles; var n = d.classes; d.name = d.elements;
                    d.classes = n = n ? n.split(/\s*,\s*/) : []; d.styles = r(e); d.attributes = r(d.attributes); d.children = []; n.length && (d.attributes["class"] = n.join(" ")); e && (d.attributes.style = CKEDITOR.tools.writeCssText(d.styles)); e = d
                } else d = a.getDefinition(), e = d.styles, n = d.attributes || {}, e && !CKEDITOR.tools.isEmpty(e) ? (e = C(e), n.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {}, e = { name: d.element, attributes: n, classes: n["class"] ? n["class"].split(/\s+/) : [], styles: e, children: [] }; var n = CKEDITOR.tools.clone(e), g = [], u; if (!1 !== b && (u = this._.transformations[e.name])) {
                    for (d =
                    0; d < u.length; ++d) q(this, e, u[d]); p(e)
                } z(this, n, g, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); b = 0 < g.length ? !1 : CKEDITOR.tools.objectCompare(e.attributes, n.attributes, !0) ? !0 : !1; "string" == typeof a && (this._.cachedChecks[k] = b); return b
        ...
        }; var P = { styles: 1, attributes: 1, classes: 1 }, O = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, B = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, E = /^cke:(object|embed|param)$/,
        K = /^(object|embed|param)$/, F; F = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) { this.lengthToStyle(a, "width"); this.lengthToStyle(a, "height") }, sizeToAttribute: function (a) { this.lengthToAttribute(a, "width"); this.lengthToAttribute(a, "height") }, lengthToStyle: function (a, b, c) { c = c || b; if (!(c in a.styles)) { var d = a.attributes[b]; d && (/^\d+$/.test(d) && (d += "px"), a.styles[c] = d) } delete a.attributes[b] }, lengthToAttribute: function (a, b, c) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, k, n, q, f; a.name = c.element; for (k in e) if ("class" ==
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, e, g) {
                var h = "string" == typeof b; h && (b = [b]); e || (e = CKEDITOR); var l = b.length, m = [], r = [], f = function (a) { c && (h ? c.call(e, a) : c.call(e, m, r)) }; if (0 === l) f(!0); else {
                    var D = function (a, b) { (b ? m : r).push(a); 0 >= --l && (g && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), f(b)) }, t = function (b, c) { a[b] = 1; var e = d[b]; delete d[b]; for (var f = 0; f < e.length; f++) e[f](b, c) }, z = function (b) {
                        if (a[b]) D(b, !0); else {
                            var e = d[b] || (d[b] = []); e.push(D); if (!(1 < e.length)) {
                                var f =
                                new CKEDITOR.dom.element("script"); f.setAttributes({ type: "text/javascript", src: b }); c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function () { if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, t(b, !0) } : (f.$.onload = function () { setTimeout(function () { t(b, !0) }, 0) }, f.$.onerror = function () { t(b, !1) })); f.appendTo(CKEDITOR.document.getHead())
                            }
                        }
                    }; g && CKEDITOR.document.getDocumentElement().setStyle("cursor", "wait"); for (var x = 0; x < l; x++) z(b[x])
                }
            },
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) { if (this.registered[a]) throw Error('[CKEDITOR.resourceManager.add] The resource name "' + a + '" is already registered.'); var b = this.registered[a] = d || {}; b.name = a; b.path = this.getPath(a); CKEDITOR.fire(a + CKEDITOR.tools.capitalize(this.fileName) + "Ready", b); return this.get(a) }, get: function (a) { return this.registered[a] || null }, getPath: function (a) { var d = this.externals[a]; return CKEDITOR.getUrl(d && d.dir || this.basePath + a + "/") }, getFilePath: function (a) {
            ...
            CKEDITOR.tools.isArray(a) || (a = a ? [a] : []); for (var c = this.loaded, e = this.registered, g = [], h = {}, l = {}, m = 0; m < a.length; m++) {
                var r = a[m]; if (r) if (c[r] || e[r]) l[r] = this.get(r); else {
                    var f = this.getFilePath(r); g.push(f); f in h || (h[f] =
                    []); h[f].push(r)
                }
            } CKEDITOR.scriptLoader.load(g, function (a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + h[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++) for (var g = h[a[f]], p = 0; p < g.length; p++) { var w = g[p]; l[w] = this.get(w); c[w] = 1 } d.call(b, l) }, this)
        }
        ...
        var d = {}; return function (b, c, e) {
            var g = {}, h = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(g, a); var b = [], f; for (f in a) { var l = a[f], t = l && l.requires; if (!d[f]) { if (l.icons) for (var z = l.icons.split(","), x = z.length; x--;) CKEDITOR.skin.addIcon(z[x], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + z[x] + ".png"); d[f] = 1 } if (t) for (t.split && (t = t.split(",")), l = 0; l < t.length; l++) g[t[l]] || b.push(t[l]) } if (b.length) h.call(this,
                    b); else { for (f in g) l = g[f], l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete g[f], l.onLoad._called = 1); c && c.call(e || window, g) }
                }, this)
            }; h.call(this, b)
        }
    ...
    (function () {
        ...
        b) { return b == CKEDITOR.ELEMENT_MODE_INLINE ? a.is(CKEDITOR.dtd.$editable) || a.is("textarea") : b == CKEDITOR.ELEMENT_MODE_REPLACE ? !a.is(CKEDITOR.dtd.$nonBodyContent) : 1 } function c() { var a = this.commands, b; for (b in a) e(this, a[b]) } function e(a, b) { b[b.startDisabled ? "disable" : a.readOnly && !b.readOnly ? "disable" : b.modes[a.mode] ? "enable" : "disable"]() } function g(a, b, c) { if (b) { var d, e, k = a.commands; for (e in k) d = k[e], (c || d.contextSensitive) && d.refresh(a, b) } } function h(a) {
            ...
            b.removePlugins; if (d) var k = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(k, ""), c = c + ("," + d); if (e) var q = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(q, ""); CKEDITOR.env.air && (c += ",adobeair"); CKEDITOR.plugins.load(c.split(","), function (c) {
                var d = [], e = [], k = []; a.plugins = c; for (var f in c) {
                    var g = c[f], u = g.lang, h = null, l = g.requires, m; CKEDITOR.tools.isArray(l) && (l = l.join(",")); if (l && (m = l.match(q))) for (; l = m.pop() ;) CKEDITOR.error("editor-plugin-required",
                    { plugin: l.replace(",", ""), requiredBy: f }); u && !a.lang[f] && (u.split && (u = u.split(",")), 0 <= CKEDITOR.tools.indexOf(u, a.langCode) ? h = a.langCode : (h = a.langCode.replace(/-.*/, ""), h = h != a.langCode && 0 <= CKEDITOR.tools.indexOf(u, h) ? h : 0 <= CKEDITOR.tools.indexOf(u, "en") ? "en" : u[0]), g.langEntries && g.langEntries[h] ? (a.lang[f] = g.langEntries[h], h = null) : k.push(CKEDITOR.getUrl(g.path + "lang/" + h + ".js"))); e.push(h); d.push(g)
                } CKEDITOR.scriptLoader.load(k, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], k = 0; k < c.length; k++) for (var n =
                    0; n < d.length; n++) { var q = d[n]; 0 === k && e[n] && q.lang && q.langEntries && (a.lang[q.name] = q.langEntries[e[n]]); if (q[c[k]]) q[c[k]](a) } a.fireOnce("pluginsLoaded"); b.keystrokes && a.setKeystroke(a.config.keystrokes); for (n = 0; n < a.config.blockedKeystrokes.length; n++) a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[n]] = 1; a.status = "loaded"; a.fireOnce("loaded"); CKEDITOR.fire("instanceLoaded", null, a)
                })
            })
        } function t() {
        ...
        } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var z = 0, x = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) { b.name = a.toLowerCase(); var c = new CKEDITOR.command(this, b); this.mode && e(this, c); return this.commands[a] = c }, _attachToForm: function () {
                ...
                this.fire("beforeDestroy"); !a && t.call(this); this.editable(null); this.filter && (this.filter.destroy(), delete this.filter); delete this.activeFilter; this.status =
    ...
    (function () {
        ...
        function (g, h, l) {
            function m(a) { var b; if (0 < w.length) for (var c = 0; c < w.length; c++) { var d = w[c], e = d.name, k = CKEDITOR.dtd[e], f = v.name && CKEDITOR.dtd[v.name]; f && !f[e] || a && k && !k[a] && CKEDITOR.dtd[a] ? e == v.name && (D(v, v.parent, 1), c--) : (b || (r(), b = 1), d = d.clone(), d.parent = v, v = d, w.splice(c, 1), c--) } } function r() { for (; H.length;) D(H.shift(), v) } function f(a) {
            ...
            } function D(b, c, d) { c = c || v || p; var e = v; void 0 === b.previous && (t(c, b) && (v = c, x.onTagOpen(l, {}), b.returnPoint = c = v), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (k = !1), "textarea" == b.name && (u = !1)); b.returnPoint ? (v = b.returnPoint, delete b.returnPoint) : v = d ? c : e } function t(a, b) {
                ...
                if (a(n)) w.push(n); else {
                    if ("pre" == e) k = !0; else { if ("br" == e && k) { v.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (u = !0) } if ("br" == e) H.push(n); else {
                        ...
                        !z(e, f)) x.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !z(e, f)) !n.returnPoint && (n.returnPoint = v), v = v.parent; else if (f in CKEDITOR.dtd.$inline && w.unshift(v), v.parent) D(v, v.parent, 1); else { n.isOrphan = 1; break } m(e); r(); n.parent = v; n.isEmpty ? D(n) : v = n
                    }
                }
            }; x.onTagClose = function (a) {
                for (var b = w.length - 1; 0 <= b; b--) if (a == w[b].name) { w.splice(b, 1); return } for (var c = [], d = [], e = v; e != p && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent; if (e != p) {
                    for (b = 0; b < c.length; b++) { var k = c[b]; D(k, k.parent) } v =
                    e; e._.isBlockLike && r(); D(e, e.parent); e == v && (v = v.parent); w = w.concat(d)
                } "body" == a && (l = !1)
            }; x.onText = function (a) { if (!(v._.hasInlineStarted && !H.length || k || u) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = v.name, f = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!u && !f["#"] && b in d) x.onTagOpen(e[b] || ""), x.onText(a); else { r(); m(); k || u || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (t(v, a)) this.onTagOpen(l, {}, 0, 1); v.add(a) } }; x.onCDATA =
            function (a) { v.add(new CKEDITOR.htmlParser.cdata(a)) }; x.onComment = function (a) { r(); m(); v.add(new CKEDITOR.htmlParser.comment(a)) }; x.parse(g); for (r() ; v != p;) D(v, v.parent, 1); f(p); return p
    ...
    (function () {
        function a() { this.rules = [] } function d(b, c, d, g) { var h, l; for (h in c) (l = b[h]) || (l = b[h] = new a), l.add(c[h], d, g) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            c, d) { for (var g = [this.findIndex(c), 0], h = 0, l = a.length; h < l; h++) g.push({ value: a[h], priority: c, options: d }); this.rules.splice.apply(this.rules, g) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;) d--; return d + 1 }, exec: function (a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), h = this.rules, l = h.length, m, r, f, D; for (D = 0; D < l; D++) if (d && (m = c.type, r = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll ||
                a.nestedEditable && f.options.excludeNestedEditable)) { f = f.value.apply(null, g); if (!1 === f || d && f && (f.name != r || f.type != m)) return f; null != f && (g[0] = c = f) } return c
    ...
    (function () {
        function a(a, d) {
            function f(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function n(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [], n = b(e), u, E; if (n) for (q(n, 1) && k.push(n) ; n;) g(n) && (u = c(n)) && q(u) && ((E = c(u)) && !g(E) ? k.push(u) : (f(y).insertAfter(u), u.remove())), n = n.previous; for (n = 0; n < k.length; n++) k[n].remove(); if (k = !a || !1 !== ("function" == typeof d ? d(e) : d)) y || CKEDITOR.env.needsBrFiller ||
                        e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (k = b(e), k = !k || "form" == e.name && "input" == k.name) : k = !1 : k = !1; k && e.add(f(a))
                    }
                }
            } function q(a, b) {
            ...
            } var u = { elements: {} }, y = "html" == d, B = CKEDITOR.tools.extend({}, k), A; for (A in B) "#" in v[A] || delete B[A]; for (A in B) u.elements[A] = n(y, a.config.fillEmptyBlocks); u.root = n(y, !1); u.elements.br = function (a) {
                return function (b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var d = b.attributes; if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                            for (d = b.next; d && e(d) ;) d =
                            d.next; var k = c(b); !d && g(b.parent) ? h(b.parent, f(a)) : g(d) && k && !g(k) && f(a).insertBefore(d)
                        }
                    }
                }
            }(y); return u
        ...
        } function h(a, b) { var c = a.children[a.children.length - 1]; a.children.push(b); b.parent = a; c && (c.next = b, b.previous = c) } function l(a) { a = a.attributes; "false" != a.contenteditable && (a["data-cke-editable"] = a.contenteditable ? "true" : 1); a.contenteditable = "false" } function m(a) { a = a.attributes; switch (a["data-cke-editable"]) { case "true": a.contenteditable = "true"; break; case "1": delete a.contenteditable } } function r(a) {
            return a.replace(J,
            function (a, b, c) { return "\x3c" + b + c.replace(G, function (a, b) { return C.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        } function f(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function D(a) { return a.replace(P, function (a, b) { return decodeURIComponent(b) }) } function t(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
            function (a) { return "\x3c!--" + H + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function z(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function x(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function p(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
            { id: 1 }), k = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g, d = [/<script[\s\S]*?(<\/script>|$)/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d); a = a.replace(/\x3c!--[\s\S]*?--\x3e/g, function (a) { return "\x3c!--{cke_tempcomment}" + (c.push(a) - 1) + "--\x3e" }); for (var n = 0; n < d.length; n++) a = a.replace(d[n], function (a) { a = a.replace(k, function (a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" }); a = a.replace(k, function (a, b, d) {
                return "\x3c!--" + H + (b ? "{C}" :
                "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\x3e"
            }); a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function (a, b) { e[e.id] = decodeURIComponent(b); return "{cke_protected_" + e.id++ + "}" }) }); return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) { return "\x3c" + c + d + "\x3e" + x(z(e), b) + "\x3c/" + c + "\x3e" })
            ...
            e, k = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = e = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(q); c.addRules(n, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); e.addRules(y); e.addRules(A, { applyToAll: !0 }); e.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                a = a.data; var c = a.dataValue, e, c = p(c, b), c = f(c, Q), c = r(c), c = f(c, Z), c = c.replace(O, "$1cke:$2"), c = c.replace(I, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                ...
                d(a.enterMode, b.config.autoParagraph); c = CKEDITOR.htmlParser.fragment.fromHtml(c, a.context, e); e && (k = c, !k.children.length && CKEDITOR.dtd[k.name][e] && (e = new CKEDITOR.htmlParser.element(e), k.add(e))); a.dataValue = c
                ...
                !1, !0)
            }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, d = k.writer; d.reset(); c.writeChildrenHtml(d); c = d.getHtml(!0); c = z(c); c = x(c, b); a.data.dataValue = c }, null, null, 15)
        }; CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var e = this.editor, k, n, f, q; b && "object" == typeof b ? (k = b.context, c = b.fixForBody, d = b.dontFilter, n = b.filter, f = b.enterMode, q = b.protectedWhitespaces) : k = b; k || null === k || (k = e.editable().getName()); return e.fire("toHtml", {
        ...
        }; var w = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", v = CKEDITOR.dtd, u = "caption colgroup col thead tfoot tbody".split(" "), k = CKEDITOR.tools.extend({}, v.$blockLimit,
        ...
        }; CKEDITOR.env.ie && (A.attributes.style = function (a) { return a.replace(/(^|;)([^\:]+)/g, function (a) { return a.toLowerCase() }) }); var J = /<(a|area|img|input|source)\b([^>]*)>/gi, G = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i, Z = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
        Q = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, P = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, O = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, B = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, I = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })(); "use strict";
    ...
    (function () {
        function a(a) { return function (b) { return b.type == CKEDITOR.NODE_ELEMENT && ("string" == typeof a ? b.name == a : b.name in a) } } var d = function (a, b) { a = a[0]; b = b[0]; return a < b ? -1 : a > b ? 1 : 0 }, b = CKEDITOR.htmlParser.fragment.prototype; CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () { return new CKEDITOR.htmlParser.element(this.name, this.attributes) }, filter: function (a, b) {
                var d = this, h, l; b = d.getFilterContext(b); if (b.off) return !0;
                if (!d.parent) a.onRoot(b, d); for (; ;) { h = d.name; if (!(l = a.onElementName(b, h))) return this.remove(), !1; d.name = l; if (!(d = a.onElement(b, d))) return this.remove(), !1; if (d !== this) return this.replaceWith(d), !1; if (d.name == h) break; if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if (!d.name) return this.replaceWithChildren(), !1 } h = d.attributes; var m, r; for (m in h) {
                    for (l = h[m]; ;) if (r = a.onAttributeName(b, m)) if (r != m) delete h[m], m = r; else break; else { delete h[m]; break } r && (!1 === (l = a.onAttribute(b, d, r, l)) ? delete h[r] :
                    h[r] = l)
                ...
                void 0 === b && (b = !1); var d = [], h; for (h = 0; h < this.children.length; h++) {
                    var l = this.children[h]; "function" == typeof a && a(l) ? d.push(l) : "string" == typeof a && l.name === a && d.push(l);
    ...
    (function () {
        function a(a, e, g, h) {
            if (!CKEDITOR.env.isCompatible) return null; a = CKEDITOR.dom.element.get(a); if (a.getEditor()) throw 'The editor instance "' + a.getEditor().name + '" is already attached to the provided element.'; var l = new CKEDITOR.editor(e, a, h); h == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"), l._.required = a.hasAttribute("required"), a.removeAttribute("required")); g && l.setData(g, null, !0); l.on("loaded", function () {
        ...
        CKEDITOR.appendTo = function (b, d, g) { return a(b, d, g, CKEDITOR.ELEMENT_MODE_APPENDTO) }; CKEDITOR.replaceAll = function () { for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) { var d = null, h = a[b]; if (h.name || h.id) { if ("string" == typeof arguments[0]) { if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(h.className)) continue } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](h, d))) continue; this.replace(h, d) } } }; CKEDITOR.editor.prototype.addMode = function (a, b) {
            ...
            var d = this, h = this._.modes; if (a != d.mode && h && h[a]) {
                d.fire("beforeSetMode", a); if (d.mode) { var l = d.checkDirty(), h = d._.previousModeData, m, r = 0; d.fire("beforeModeUnload"); d.editable(0); d._.previousMode = d.mode; d._.previousModeData = m = d.getData(1); "source" == d.mode && h == m && (d.fire("lockSnapshot", { forceUpdate: !0 }), r = 1); d.ui.space("contents").setHtml(""); d.mode = "" } else d._.previousModeData = d.getData(1); this._.modes[a](function () {
                    d.mode = a; void 0 !== l && !l &&
            ...
            var l = this.container, m = this.ui.space("contents"), r = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement; h = h ? this.container.getFirst(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : l; h.setSize("width", a, !0); r && (r.style.width = "1%"); var f = (h.$.offsetHeight || 0) - (m.$.clientHeight ||
            0), l = Math.max(b - (d ? 0 : f), 0); b = d ? b + f : b; m.setStyle("height", l + "px"); r && (r.style.width = "100%"); this.fire("resize", { outerHeight: b, contentsHeight: l, outerWidth: a || h.getSize("width") })
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, n = e.blockLimit, f = a.data.selection, g = f.getRanges()[0], l; if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (f = d(f, e)) f.appendBogus(), l = CKEDITOR.env.ie; h(b, e.block, n) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), n = new CKEDITOR.dom.walker(e), n.guard = function (a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !n.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
        ...
        function l(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function m(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function r(a, b, c) { var d = a.getCommonAncestor(b); for (b = a = c ? b : a; (a = a.getParent()) && !d.equals(a) && 1 == a.getChildCount() ;) b = a; b.remove() } var f, D, t, z, x, p, w, H, v; CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                b) { var c = this.getAttribute(a); b !== c && (!this._.attrChanges && (this._.attrChanges = {}), a in this._.attrChanges || (this._.attrChanges[a] = c), this.setAttribute(a, b)) }, insertText: function (a) { this.editor.focus(); this.insertHtml(this.transformPlainTextToHtml(a), "text") }, transformPlainTextToHtml: function (a) { var b = this.editor.getSelection().getStartElement().hasAscendant("pre", !0) ? CKEDITOR.ENTER_BR : this.editor.activeEnterMode; return CKEDITOR.tools.transformPlainTextToHtml(a, b) }, insertHtml: function (a, b, c) {
                    var d =
                    this.editor; d.focus(); d.fire("saveSnapshot"); c || (c = d.getSelection().getRanges()[0]); p(this, b || "html", a, c); c.select(); m(this); this.editor.fire("afterInsertHtml", {})
                    ...
                    CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function (a) { return c(a) && !z(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f)))); d.selectRanges([b]); m(this)
                ...
                fixInitialSelection: function () {
                    ...
                    var c = v, d = { range: a, doc: a.document }, e = this.getHtmlFromRange(a); if (a.collapsed) return a.optimize(), e; a.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.table.detectPurge(d); d.bookmark = a.createBookmark(); delete d.range; var f = this.editor.createRange();
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"), f = 0, g; if (d) for (; g = d.getItem(f++) ;) if (!D(g)) { d = !0; break a } d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), t(a.startContainer) && a.startContainer.appendBogus(); a.startContainer.mergeSiblings(); return e
                }, setup: function () {
                    ...
                    this.attachClass("cke_editable_themed"); this.attachClass("cke_contents_" + a.config.contentsLangDirection); a.keystrokeHandler.blockedKeystrokes[8] = +a.readOnly; a.keystrokeHandler.attach(this); this.on("blur", function () { this.hasFocus = !1 }, null, null, -1); this.on("focus", function () { this.hasFocus = !0 }, null, null, -1); if (CKEDITOR.env.webkit) this.on("scroll", function () { a._.previousScrollTop = a.editable().$.scrollTop }, null, null, -1); if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) {
                        ...
                        a.document = this.getDocument(); a.window = this.getWindow(); var e = a.document; this.changeAttr("spellcheck",
                        ...
                        n + 1); this.setCustomData("cke_includeReadonly", !a.config.disableReadonlyStyling); this.attachListener(this, "click", function (a) { a = a.data; var b = (new CKEDITOR.dom.elementPath(a.getTarget(), this)).contains("a"); b && 2 != a.$.button && b.isReadOnly() && a.preventDefault() }); var J = { 8: 1, 46: 1 }; this.attachListener(a, "key", function (b) {
                            if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d; if (c in J) {
                                b = a.getSelection(); var e, k = b.getRanges()[0], n = k.startPath(), q, h, y, c = 8 == c; CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (e =
                        ...
                        function (b) { b.data.getKeystroke() in J && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) }); this.attachListener(this, "dblclick", function (b) { if (a.readOnly) return !1; b = { element: b.data.getTarget() }; a.fire("doubleclick", b) }); CKEDITOR.env.ie && this.attachListener(this, "click", b); CKEDITOR.env.ie && !CKEDITOR.env.edge || this.attachListener(this, "mousedown", function (b) {
                        ...
                        "click", function (a) { a.data.getTarget().is("input", "select") && a.data.preventDefault() }), this.attachListener(this, "mouseup", function (a) { a.data.getTarget().is("input", "textarea") && a.data.preventDefault() })); CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            if (a.readOnly) return !0; b = b.data.domEvent.getKey(); if (b in J) {
                                var c = 8 == b, d = a.getSelection().getRanges()[0]; b = d.startPath(); if (d.collapsed) a: {
                                    var e = b.block; if (e && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(e,
                                    !c) && d.collapsed) { if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var f = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (f && f.type == CKEDITOR.NODE_ELEMENT && f.is("hr")) { a.fire("saveSnapshot"); f.remove(); b = !0; break a } } d = d.startPath().block; if (!d || d && d.contains(e)) b = void 0; else { a.fire("saveSnapshot"); var k; (k = (c ? d : e).getBogus()) && k.remove(); k = a.getSelection(); f = k.createBookmarks(); (c ? e : d).moveChildren(c ? d : e, !1); b.lastElement.mergeSiblings(); r(e, d, !c); k.selectBookmarks(f); b = !0 } } else b = !1
                                } else c = d,
                                k = b.block, d = c.endPath().block, k && d && !k.equals(d) ? (a.fire("saveSnapshot"), (e = k.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(k, !1), b.lastElement.mergeSiblings(), r(k, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1; if (!b) return; a.getSelection().scrollIntoView(); a.fire("saveSnapshot"); return !1
                            }
                        }, this, null, 100)
                    }
                }
            ...
            var b = a.editor; b.on("mode", function () {
                var a = b.editable(); if (a && a.isInline()) {
                    ...
                    "contents"))) { var e = CKEDITOR.tools.getNextId(), d = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + e + '" class\x3d"cke_voice_label"\x3e' + d + "\x3c/span\x3e"); c.append(d); a.changeAttr("aria-describedby", e) }
                }
            })
        }); CKEDITOR.addCss(".cke_editable{cursor:text}.cke_editable img,.cke_editable input,.cke_editable textarea{cursor:default}"); f = CKEDITOR.dom.walker.whitespaces(!0); D = CKEDITOR.dom.walker.bookmark(!1, !0); t = CKEDITOR.dom.walker.empty(); z = CKEDITOR.dom.walker.bogus(); x = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi;
        p = function () {
            function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                var e, f, n, g, q = [], h = d.range.startContainer; e = d.range.startPath(); for (var h = p[h.getName()], y = 0, l = c.getChildren(), A = l.count(), J = -1, m = -1, r = 0, C = e.contains(p.$list) ; y < A; ++y) e = l.getItem(y), a(e) ? (n = e.getName(), C && n in CKEDITOR.dtd.$list ? q = q.concat(b(e, d)) : (g = !!h[n], "br" != n || !e.data("cke-eol") || y && y != A - 1 || (r = (f = y ? q[y - 1].node : l.getItem(y + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && p.$block[f.getName()]), -1 != J || g || (J = y), g || (m = y), q.push({
                    isElement: 1,
                    isLineBreak: r, isBlock: e.isBlockBoundary(), hasBlockSibling: f, node: e, name: n, allowed: g
                }), f = r = 0)) : q.push({ isElement: 0, node: e, allowed: 1 }); -1 < J && (q[J].firstNotAllowed = 1); -1 < m && (q[m].lastNotAllowed = 1); return q
            } function d(b, c) { var e = [], f = b.getChildren(), k = f.count(), n, g = 0, h = p[c], y = !b.is(p.$inline) || b.is("br"); for (y && e.push(" ") ; g < k; g++) n = f.getItem(g), a(n) && !n.is(h) ? e = e.concat(d(n, c)) : e.push(n); y && e.push(" "); return e } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) {
                return b &&
                a(b) && (b.is(p.$removeEmpty) || b.is("a") && !b.isBlockBoundary())
            } function g(b, c, d, e) { var f = b.clone(), k, n; f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (k = (new CKEDITOR.dom.walker(f)).next()) && a(k) && m[k.getName()] && (n = k.getPrevious()) && a(n) && !n.getParent().equals(b.startContainer) && d.contains(n) && e.contains(k) && k.isIdentical(n) && (k.moveChildren(n), k.remove(), g(b, c, d, e)) } function J(b, c) {
            ...
            } var p = CKEDITOR.dtd, m = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, r = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, w = CKEDITOR.tools.extend({}, p.$inline); delete w.br; return function (m, C, B, I) {
                var E = m.editor, K = !1; "unfiltered_html" == C && (C = "html", K = !0); if (!I.checkReadOnly()) {
                    var F = (new CKEDITOR.dom.elementPath(I.startContainer, I.root)).blockLimit ||
                    I.root; m = { type: C, dontFilter: K, editable: m, editor: E, range: I, blockLimit: F, mergeCandidates: [], zombies: [] }; C = m.range; I = m.mergeCandidates; var L, t; "text" == m.type && C.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (L = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", C.document), C.insertNode(L), C.setStartAfter(L)); K = new CKEDITOR.dom.elementPath(C.startContainer); m.endPath = F = new CKEDITOR.dom.elementPath(C.endContainer); if (!C.collapsed) {
                        var E = F.block || F.blockLimit, D = C.getCommonAncestor(); E && !E.equals(D) &&
                        !E.contains(D) && C.checkEndOfBlock() && m.zombies.push(E); C.deleteContents()
                    ...
                    E.getParent()) && f(E) ;) I.push(E); C.moveToBookmark(L); if (L = B) {
                        L = m.range; if ("text" == m.type && m.inlineStylesRoot) { t = m.inlineStylesPeak; C = t.getDocument().createText("{cke-peak}"); for (I = m.inlineStylesRoot.getParent() ; !t.equals(I) ;) C = C.appendTo(t.clone()), t = t.getParent(); B = C.getOuterHtml().split("{cke-peak}").join(B) } t = m.blockLimit.getName(); if (/^\s+|\s+$/.test(B) && "span" in CKEDITOR.dtd[t]) { var z = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; B = z + B + z } B = m.editor.dataProcessor.toHtml(B, {
                            context: null,
                            fixForBody: !1, protectedWhitespaces: !!z, dontFilter: m.dontFilter, filter: m.editor.activeFilter, enterMode: m.editor.activeEnterMode
                        }); t = L.document.createElement("body"); t.setHtml(B); z && (t.getFirst().remove(), t.getLast().remove()); if ((z = L.startPath().block) && (1 != z.getChildCount() || !z.getBogus())) a: {
                            var v; if (1 == t.getChildCount() && a(v = t.getFirst()) && v.is(r) && !v.hasAttribute("contenteditable")) {
                                z = v.getElementsByTag("*"); L = 0; for (I = z.count() ; L < I; L++) if (C = z.getItem(L), !C.is(w)) break a; v.moveChildren(v.getParent(1));
                                v.remove()
                            }
                        } m.dataWrapper = t; L = B
                    } if (L) {
                        v = m.range; L = v.document; var x; t = m.blockLimit; I = 0; var N, z = [], M, H; B = E = 0; var S, X; C = v.startContainer; var K = m.endPath.elements[0], Y, F = K.getPosition(C), D = !!K.getCommonAncestor(C) && F != CKEDITOR.POSITION_IDENTICAL && !(F & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED); C = b(m.dataWrapper, m); for (J(C, v) ; I < C.length; I++) {
                            F = C[I]; if (x = F.isLineBreak) {
                                ...
                                x = v.startPath(); !F.isBlock && h(m.editor, x.block, x.blockLimit) && (H = l(m.editor)) && (H = L.createElement(H), H.appendBogus(), v.insertNode(H), CKEDITOR.env.needsBrFiller && (N = H.getBogus()) && N.remove(), v.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END)); if ((x = v.startPath().block) && !x.equals(M)) {
                                    if (N = x.getBogus()) N.remove(), z.push(x);
                                    M = x
                                } F.firstNotAllowed && (E = 1); if (E && F.isElement) { x = v.startContainer; for (S = null; x && !p[x.getName()][F.name];) { if (x.equals(t)) { x = null; break } S = x; x = x.getParent() } if (x) S && (X = v.splitElement(S), m.zombies.push(X), m.zombies.push(S)); else { S = t.getName(); Y = !I; x = I == C.length - 1; S = d(F.node, S); for (var U = [], ba = S.length, ca = 0, ea = void 0, fa = 0, ha = -1; ca < ba; ca++) ea = S[ca], " " == ea ? (fa || Y && !ca || (U.push(new CKEDITOR.dom.text(" ")), ha = U.length), fa = 1) : (U.push(ea), fa = 0); x && ha == U.length && U.pop(); Y = U } } if (Y) {
                                    for (; x = Y.pop() ;) v.insertNode(x);
                                    Y = 0
                                } else v.insertNode(F.node); F.lastNotAllowed && I < C.length - 1 && ((X = D ? K : X) && v.setEndAt(X, CKEDITOR.POSITION_AFTER_START), E = 0); v.collapse()
                            }
                        } 1 != C.length ? N = !1 : (N = C[0], N = N.isElement && "false" == N.node.getAttribute("contenteditable")); N && (B = !0, x = C[0].node, v.setStartAt(x, CKEDITOR.POSITION_BEFORE_START), v.setEndAt(x, CKEDITOR.POSITION_AFTER_END)); m.dontMoveCaret = B; m.bogusNeededBlocks = z
                    } N = m.range; var T; X = m.bogusNeededBlocks; for (Y = N.createBookmark() ; M = m.zombies.pop() ;) M.getParent() && (H = N.clone(), H.moveToElementEditStart(M),
                    H.removeEmptyBlocksAtEnd()); if (X) for (; M = X.pop() ;) CKEDITOR.env.needsBrFiller ? M.appendBogus() : M.append(N.document.createText(" ")); for (; M = m.mergeCandidates.pop() ;) M.mergeSiblings(); N.moveToBookmark(Y); if (!m.dontMoveCaret) { for (M = e(N) ; M && a(M) && !M.is(p.$empty) ;) { if (M.isBlockBoundary()) N.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END); else { if (f(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { T = null; break } T = N.clone(); T.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END) } M = M.getLast(c) } T && N.moveToRange(T) }
                }
            }
        }(); w = function () {
            function a(b) {
            ...
            function a(b, c) { var d = b.getParent(); if (d.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](d) } function b(c, d, e) {
                ...
                list: {
                    ...
                    function a(c) {
                        var e = [], f, k = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d), n = c.endPath().contains(d), h = {}; k.guard = function (a, k) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) { var q = "visited_" + (k ? "out" : "in"); if (a.getCustomData(q)) return; CKEDITOR.dom.element.setMarker(h, a, q, 1) } if (k && g && a.equals(g)) f = c.clone(), f.setEndAt(g, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!k && n && a.equals(n)) f = c.clone(), f.setStartAt(n, CKEDITOR.POSITION_AFTER_START),
                            e.push(f); else { if (q = !k) q = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!n || b(a, n)); q && (f = c.clone(), f.selectNodeContents(a), e.push(f)) }
                        ...
                        detectPurge: function (a) {
                            ...
                            var k = c(f, e.bookmark), g = k.clone(), h, l, m = k.getCommonAncestor(); m.is(CKEDITOR.dtd.$tableContent) && !m.is(d) && (m = m.getAscendant("table",
                        ...
                        }, deleteRanges: function (a) { for (var b; b = a.tableContentsRanges.pop() ;) b.extractContents(), t(b.startContainer) && b.startContainer.appendBogus(); a.tableSurroundingRange && a.tableSurroundingRange.extractContents() }, purge: function (a) {
                    ...
                    var c = b.startPath(), d; h(a, c.block, c.blockLimit) && (d = l(a)) && (d = b.document.createElement(d), d.appendBogus(),
    ...
    (function () {
        function a() {
        ...
        } function d() { w = !0; p || (b.call(this), p = CKEDITOR.tools.setTimeout(b, 200, this)) } function b() { p = null; w && (CKEDITOR.tools.setTimeout(a, 0, this), w = !1) } function c(a) { return H(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function e(a) {
        ...
        } function g(a) { h(a, !1); var b = a.getDocument().createText(z); a.setCustomData("cke-fillingChar", b); return b } function h(a, b) {
        ...
        } function l(a, b) { return b ? a.replace(x, function (a, b) { return b ? " " : "" }) : a.replace(z, "") } function m(a, b) {
        ...
        } var D = "function" != typeof window.getSelection, t = 1, z = CKEDITOR.tools.repeat("​", 7), x = new RegExp(z + "( )?", "g"), p, w, H = CKEDITOR.dom.walker.invisible(1), v = function () {
            function a(b) {
                return function (a) {
                ...
                "mousedown", function () { p = 0 }); if (CKEDITOR.env.ie || m) D ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () { e.lockSelection(B); p = 1 }, null, null, -1), g.attachListener(g, "mousedown", function () { p = 0 }); if (CKEDITOR.env.ie && !m) {
                    ...
                    g.attachListener(g, "mouseup", function (a) { 2 == a.data.$.button && I && (e.document.$.documentElement.scrollLeft = I.x, e.document.$.documentElement.scrollTop = I.y); I = null }); if ("BackCompat" != f.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            var E, K; l.on("mousedown", function (a) {
                                function b(a) { a = a.data.$; if (E) { var c = q.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } E.setEndPoint(0 > K.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); E.select() } } function c() {
                                    l.removeListener("mousemove",
                                    b); k.removeListener("mouseup", c); l.removeListener("mouseup", c); E.select()
                                } a = a.data; if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { E = q.$.createTextRange(); try { E.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } K = E.duplicate(); l.on("mousemove", b); k.on("mouseup", c); l.on("mouseup", c) }
                            })
            ...
            }, null, null, 100); e.on("key", function (a) { if ("wysiwyg" == e.mode) { var b = e.getSelection(); if (b.isFake) { var c = v[a.data.keyCode]; if (c) return c({ editor: e, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
        ...
        CKEDITOR.dom.document.prototype.getSelection = function () { return new CKEDITOR.dom.selection(this) }; CKEDITOR.dom.range.prototype.select = function () { var a = this.root instanceof CKEDITOR.editable ? this.root.editor.getSelection() : new CKEDITOR.dom.selection(this.root); a.selectRanges([this]); return a }; CKEDITOR.SELECTION_NONE = 1; CKEDITOR.SELECTION_TEXT = 2; CKEDITOR.SELECTION_ELEMENT = 3; CKEDITOR.dom.selection = function (a) {
        ...
        }; var u = { img: 1, hr: 1, li: 1, table: 1, tr: 1, td: 1, th: 1, embed: 1, object: 1, ol: 1, ul: 1, a: 1, input: 1, form: 1, select: 1, textarea: 1, button: 1, fieldset: 1, thead: 1, tfoot: 1 }; CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
            _removeFillingCharSequenceString: l,
            _createFillingCharSequenceNode: g, FILLING_CHAR_SEQUENCE: z
        }); CKEDITOR.dom.selection.prototype = {
            getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = D ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: D ? function () {
            ...
            } : function () { var a = this._.cache; if (a.type) return a.type; var b = CKEDITOR.SELECTION_TEXT, c = this.getNative(); if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) { var c = c.getRangeAt(0), d = c.startContainer; d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && u[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT) } return a.type = b }, getRanges: function () {
                var a = D ? function () {
                    function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() }
                    var b = function (b, c) {
                        b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, f, g, k = b.duplicate(), h = 0, l = e.length - 1, B = -1, n, m; h <= l;) if (B = Math.floor((h + l) / 2), f = e[B], k.moveToElementText(f), n = k.compareEndPoints("StartToStart", b), 0 < n) l = B - 1; else if (0 > n) h = B + 1; else return { container: d, offset: a(f) }; if (-1 == B || B == e.length - 1 && 0 > n) {
                            k.moveToElementText(d); k.setEndPoint("StartToStart", b); k = k.text.replace(/(\r\n|\r)/g, "\n").length; e = d.childNodes; if (!k) return f =
                            e[e.length - 1], f.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: f, offset: f.nodeValue.length }; for (d = e.length; 0 < k && 0 < d;) g = e[--d], g.nodeType == CKEDITOR.NODE_TEXT && (m = g, k -= g.nodeValue.length); return { container: m, offset: -k }
                        } k.collapse(0 < n ? !0 : !1); k.setEndPoint(0 < n ? "StartToStart" : "EndToStart", b); k = k.text.replace(/(\r\n|\r)/g, "\n").length; if (!k) return { container: d, offset: a(f) + (0 < n ? 0 : 1) }; for (; 0 < k;) try {
                            g = f[0 < n ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (k -= g.nodeValue.length,
                            m = g), f = g
                        } catch (p) { return { container: d, offset: a(f) } } return { container: m, offset: 0 < n ? -k : m.nodeValue.length + k }
                    }; return function () {
                        ...
                        a.collapse(), [a]; if (d == CKEDITOR.SELECTION_ELEMENT) { for (var d = [], e = 0; e < c.length; e++) { for (var f = c.item(e), g = f.parentNode, k = 0, a = new CKEDITOR.dom.range(this.root) ; k < g.childNodes.length && g.childNodes[k] != f; k++); a.setStart(new CKEDITOR.dom.node(g), k); a.setEnd(new CKEDITOR.dom.node(g), k + 1); d.push(a) } return d } return []
                    }
                }() : function () {
                ...
                var a =
                this._.cache; if (void 0 !== a.selectedText) return a.selectedText; var b = this.getNative(), b = D ? "Control" == b.type ? "" : b.createRange().text : b.toString(); return a.selectedText = b
            ...
            }, reset: function () { this._.cache = {}; this.isFake = 0; var a = this.root.editor; if (a && a._.fakeSelection) if (this.rev == a._.fakeSelection.rev) { delete a._.fakeSelection; var b = a._.hiddenSelectionContainer; if (b) { var c = a.checkDirty(); a.fire("lockSnapshot"); b.remove(); a.fire("unlockSnapshot"); !c && a.resetDirty() } delete a._.hiddenSelectionContainer } else CKEDITOR.warn("selection-fake-reset"); this.rev = t++ }, selectElement: function (a) {
                var b =
                ...
                var b = this.root.editor, b = b && b._.hiddenSelectionContainer; this.reset(); if (b) for (var b = this.root, c, d = 0; d < a.length; ++d) c = a[d], c.endContainer.equals(b) && (c.endOffset = Math.min(c.endOffset, b.getChildCount())); if (a.length) if (this.isLocked) { var f = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); f && !f.equals(this.root) && f.focus() } else {
                    var l; a: {
                        ...
                        !(p = a[0]).collapsed && (l = p.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (p = p.clone(), p.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (m = p.getEnclosedNode()) && m.type == CKEDITOR.NODE_ELEMENT && (l = m), "false" == l.getAttribute("contenteditable"))) break a; l = void 0
                    } if (l) this.fake(l); else {
                        if (D) {
                            p = CKEDITOR.dom.walker.whitespaces(!0); m = /\ufeff|\u00a0/; b = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (l = a[a.length - 1], a[0].setEnd(l.endContainer, l.endOffset)); l = a[0]; a = l.collapsed; var r, t, x; if ((c = l.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT &&
                            ...
                            f = this.getNative(); if (!f) return; this.removeAllRanges(); for (x = 0; x < a.length; x++) {
                                if (x < a.length - 1 && (r = a[x], t = a[x + 1], m = r.clone(), m.setStart(r.endContainer, r.endOffset), m.setEnd(t.startContainer, t.startOffset), !m.collapsed && (m.shrink(CKEDITOR.NODE_ELEMENT, !0), l = m.getCommonAncestor(), m = m.getEnclosedNode(), l.isReadOnly() || m && m.isReadOnly()))) { t.setStart(r.startContainer, r.startOffset); a.splice(x--, 1); continue } l = a[x]; t = this.document.$.createRange();
                                l.collapsed && CKEDITOR.env.webkit && e(l) && (m = g(this.root), l.insertNode(m), (r = m.getNext()) && !m.getPrevious() && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() ? (h(this.root), l.moveToPosition(r, CKEDITOR.POSITION_BEFORE_START)) : l.moveToPosition(m, CKEDITOR.POSITION_AFTER_END)); t.setStart(l.startContainer.$, l.startOffset); try { t.setEnd(l.endContainer.$, l.endOffset) } catch (B) { if (0 <= B.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), t.setEnd(l.endContainer.$, l.endOffset); else throw B; } f.addRange(t)
                            }
                        } this.reset();
                        this.root.fire("selectionchange")
                    }
                }
            }, fake: function (a, b) { var c = this.root.editor; void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label")); this.reset(); m(c, b); var d = this._.cache, e = new CKEDITOR.dom.range(this.root); e.setStartBefore(a); e.setEndAfter(a); d.ranges = new CKEDITOR.dom.rangeList(e); d.selectedElement = d.startElement = a; d.type = CKEDITOR.SELECTION_ELEMENT; d.selectedText = d.nativeSel = null; this.isFake = 1; this.rev = t++; c._.fakeSelection = this; this.root.fire("selectionchange") }, isHidden: function () {
                var a =
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b) ;) if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var f = c.document; if (c.collapsed) f = H(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, l, k = h.ignoreReadonly, m = k || h.includeReadonly; null ==
                m && (m = c.root.getCustomData("cke_includeReadonly")); var n = CKEDITOR.dtd[g]; n || (l = !0, n = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var p = c.createBookmark(), q = p.startNode, r = p.endNode, t = q, u; if (!k) { var z = c.getCommonAncestor(), k = a(q, z), z = a(r, z); k && (t = k.getNextSourceNode(!0)); z && (r = z) } for (t.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (t = 0) ; t;) {
                    k = !1; if (t.equals(r)) t = null, k = !0; else {
                        var v = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null, z = v && "false" == t.getAttribute("contentEditable"), w = v &&
                        t.getAttribute("data-nostyle"); if (v && t.data("cke-bookmark")) { t = t.getNextSourceNode(!0); continue } if (z && m && CKEDITOR.dtd.$block[v]) for (var D = t, y = e(D), A = void 0, C = y.length, G = 0, D = C && new CKEDITOR.dom.range(D.getDocument()) ; G < C; ++G) { var A = y[G], J = CKEDITOR.filter.instances[A.data("cke-filter")]; if (J ? J.check(this) : 1) D.selectNodeContents(A), b.call(this, D) } y = v ? !n[v] || w ? 0 : z && !m ? 0 : d(t, r, h, P) : 1; if (y) if (A = t.getParent(), y = h, C = g, G = l, !A || !(A.getDtd() || CKEDITOR.dtd.span)[C] && !G || y.parentRule && !y.parentRule(A)) k = !0; else {
                            if (u ||
                            v && CKEDITOR.dtd.$removeEmpty[v] && (t.getPosition(r) | P) != P || (u = c.clone(), u.setStartBefore(t)), v = t.type, v == CKEDITOR.NODE_TEXT || z || v == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) { for (var v = t, Q; (k = !v.getNext(Z)) && (Q = v.getParent(), n[Q.getName()]) && d(Q, q, h, O) ;) v = Q; u.setEndAfter(v) }
                        } else k = !0; t = t.getNextSourceNode(w || z)
                    } if (k && u && !u.collapsed) {
                        for (var k = H(this, f), z = k.hasAttributes(), w = u.getCommonAncestor(), v = {}, y = {}, A = {}, C = {}, T, W, da; k && w;) {
                            if (w.getName() == g) {
                                ...
                                (k.getAttribute(T) == da ? y[T] = 1 : C[T] = 1); for (W in h.styles) !A[W] && (da = w.getStyle(W)) && (k.getStyle(W) == da ? v[W] = 1 : A[W] = 1)
                            } w = w.getParent()
                        } for (T in y) k.removeAttribute(T); for (W in v) k.removeStyle(W); z && !k.hasAttributes() && (k = null); k ? (u.extractContents().appendTo(k), u.insertNode(k), x.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(k), u.insertNode(k), x.call(this, k), k.remove(!0)); u = null
                    }
            ...
            a.createBookmark(), d = c.startNode; if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, h; g < e.elements.length && (h = e.elements[g]) && h != e.block && h != e.blockLimit; g++) if (this.checkElementRemovable(h)) { var l; a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (l = a.checkBoundaryOfElement(h, CKEDITOR.START))) ? (f = h, f.match = l ? "start" : "end") : (h.mergeSiblings(), h.is(this.element) ? z.call(this, h) : p(h, k(this)[h.getName()])) } if (f) {
                    h = d; for (g = 0; ; g++) {
            ...
            } else { var m = c.endNode, n = this; b(); for (e = d; !e.equals(m) ;) f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? z.call(this, e) : p(e, k(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f } a.moveToBookmark(c); a.shrink(CKEDITOR.NODE_ELEMENT, !0)
        } function e(a) {
            var b = []; a.forEach(function (a) {
                if ("true" ==
                a.getAttribute("contenteditable")) return b.push(a), !1
            }, CKEDITOR.NODE_ELEMENT, !0); return b
        } function g(a) { var b = a.getEnclosedNode() || a.getCommonAncestor(!1, !0); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && v(a, this) } function h(a) {
        ...
        } function l(a) { var b = a.createBookmark(!0), c = a.createIterator(); c.enforceRealBlocks = !0; this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph() ;) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), r(d, f)); a.moveToBookmark(b) } function m(a) {
            ...
            } else g ? b = t(c ? [a.getHtml()] : f(a), b) : a.moveChildren(b); b.replace(a); if (d) {
                var c = b, k; (k = c.getPrevious(Q)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = D(k.getHtml(), /\n$/, "") + "\n\n" + D(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
                c.setHtml(d), k.remove())
            } else c && w(b)
        } function f(a) { var b = []; D(a.getOuterHtml(), /(\S\s*)\n(?:\s|(<span[^>]+data-cke-bookmark.*?\/span>))*\n(?!$)/gi, function (a, b, c) { return b + "\x3c/pre\x3e" + c + "\x3cpre\x3e" }).replace(/<pre\b.*?>([\s\S]*?)<\/pre>/gi, function (a, c) { b.push(c) }); return b } function D(a, b, c) { var d = "", e = ""; a = a.replace(/(^<span[^>]+data-cke-bookmark.*?\/span>)|(<span[^>]+data-cke-bookmark.*?\/span>$)/gi, function (a, b, c) { b && (d = b); c && (e = c); return "" }); return d + a.replace(b, c) + e } function t(a, b) {
            var c;
        ...
        } function x(a) { for (var b = k(this), c = a.getElementsByTag(this.element), d, e = c.count() ; 0 <= --e;) d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || p(d, b[f]) } function p(a, b, c) {
            ...
            if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(Q), d = a.getNext(Q); !c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1); !d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br"); a.remove(!0) } else c = a.getFirst(), d = a.getLast(), a.remove(!0), c && (c.type == CKEDITOR.NODE_ELEMENT && c.mergeSiblings(),
            d && !c.equals(d) && d.type == CKEDITOR.NODE_ELEMENT && d.mergeSiblings())
        } function H(a, b, c) { var d; d = a.element; "*" == d && (d = "span"); d = new CKEDITOR.dom.element(d, b); c && c.copyAttributes(d); d = v(d, a); b.getCustomData("doc_processing_style") && d.hasAttribute("id") ? d.removeAttribute("id") : b.setCustomData("doc_processing_style", 1); return d } function v(a, b) { var c = b._.definition, d = c.attributes, c = CKEDITOR.style.getStyleText(c); if (d) for (var e in d) a.setAttribute(e, d[e]); c && a.setAttribute("style", c); return a } function u(a,
        ...
        } var A = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 }, J = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 }, G = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, Z = CKEDITOR.dom.walker.bookmark(0,
        1), Q = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
            ...
            }, applyToRange: function (a) { this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? l : this.type == CKEDITOR.STYLE_OBJECT ? g : null; return this.applyToRange(a) }, removeFromRange: function (a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? m : this.type == CKEDITOR.STYLE_OBJECT ? h : null; return this.removeFromRange(a) }, applyToObject: function (a) {
                v(a,
                this)
    ...
    (function () {
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, e) {
            var g = null, h = null, l = [], m = b, r; e = e || b.getDocument().getBody(); do if (m.type == CKEDITOR.NODE_ELEMENT) {
                l.push(m); if (!this.lastElement && (this.lastElement = m, m.is(CKEDITOR.dtd.$object) || "false" == m.getAttribute("contenteditable"))) continue; if (m.equals(e)) break; if (!h && (r = m.getName(),
                "true" == m.getAttribute("contenteditable") ? h = m : !g && d[r] && (g = m), a[r])) { if (r = !g && "div" == r) { a: { r = m.getChildren(); for (var f = 0, D = r.count() ; f < D; f++) { var t = r.getItem(f); if (t.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[t.getName()]) { r = !0; break a } } r = !1 } r = !r } r ? g = m : h = m }
                ...
                var a = this, c = CKEDITOR.dom.walker.bookmark(), d = [], g; return {
                    getNextRange: function (h) {
                        g = void 0 === g ? 0 : g + 1; var l = a[g]; if (l && 1 < a.length) {
                            if (!g) for (var m = a.length - 1; 0 <= m; m--) d.unshift(a[m].createBookmark(!0)); if (h) for (var r = 0; a[g + r + 1];) {
                                var f = l.document; h = 0; m = f.getById(d[r].endNode); for (f = f.getById(d[r + 1].startNode) ; ;) {
                                    m =
...
*/
    ...
    CKEDITOR.config.coreStyles_superscript = { element: "sup" }; (function () {
        ...
        function r(b, a, c) { a.type || (a.type = "auto"); if (c && !1 === b.fire("beforePaste", a) || !a.dataValue && a.dataTransfer.isEmpty()) return !1; a.dataValue || (a.dataValue = ""); if (CKEDITOR.env.gecko && "drop" == a.method && b.toolbox) b.once("afterPaste", function () { b.toolbox.focus() }); return b.fire("paste", a) } function y(b) {
            function a() {
            ...
            } function c(a) { return { type: a, canUndo: "cut" == a, startDisabled: !0, fakeKeystroke: "cut" == a ? CKEDITOR.CTRL + 88 : CKEDITOR.CTRL + 67, exec: function () { "cut" == this.type && h(); var a; var d = this.type; if (CKEDITOR.env.ie) a = f(d); else try { a = b.document.$.execCommand(d, !1, null) } catch (c) { a = !1 } a || b.showNotification(b.lang.clipboard[this.type + "Error"]); return a } } } function d() {
                return {
                    canUndo: !1,
                    async: !0, fakeKeystroke: CKEDITOR.CTRL + 86, exec: function (b, a) { var d = this, c = function (a, c) { a && r(b, a, !!c); b.fire("afterCommandExec", { name: "paste", command: d, returnValue: !!a }) }; "string" == typeof a ? c({ dataValue: a, method: "paste", dataTransfer: n.initPasteDataTransfer() }, 1) : b.getClipboardData(c) }
                }
                ...
                var c = b.document, e = b.editable(), f = function (b) { b.cancel() }, q;
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.gecko) q = e.once("blur", f, null, null, -100); k && m.focus(); k = new CKEDITOR.dom.range(m); k.selectNodeContents(m); var t = k.select(); CKEDITOR.env.ie && (q = e.once("blur", function () { b.lockSelection(t) })); var l = CKEDITOR.document.getWindow().getScrollPosition().y; setTimeout(function () {
                        CKEDITOR.env.webkit && (CKEDITOR.document.getBody().$.scrollTop = l); q && q.removeListener(); CKEDITOR.env.ie && e.focus(); g.selectBookmarks(h); m.remove(); var a; CKEDITOR.env.webkit && (a = m.getFirst()) && a.is && a.hasClass("Apple-style-span") &&
                ...
                if ("wysiwyg" == b.mode) switch (a.data.keyCode) {
                    case CKEDITOR.CTRL + 86: case CKEDITOR.SHIFT + 45: a = b.editable(); e(); "paste" == n.mainPasteEvent && a.fire("beforepaste"); break; case CKEDITOR.CTRL + 88: case CKEDITOR.SHIFT +
                ...
                if ("wysiwyg" == b.mode) {
                    var a = u("paste"); b.getCommand("cut").setState(u("cut"));
                ...
                function a(d, c, e, f, q) { var g = b.lang.clipboard[c]; b.addCommand(c, e); b.ui.addButton && b.ui.addButton(d, { label: g, command: c, toolbar: "clipboard," + f }); b.addMenuItems && b.addMenuItem(c, { label: g, command: c, group: "clipboard", order: q }) } a("Cut", "cut", c("cut"), 10, 1); a("Copy", "copy", c("copy"), 20, 4); a("Paste",
                "paste", d(), 30, 8)
            })(); b.getClipboardData = function (a, d) {
                function c(a) { a.removeListener(); a.cancel(); d(a.data) } function e(a) { a.removeListener(); a.cancel(); k = !0; d({ type: g, dataValue: a.data.dataValue, dataTransfer: a.data.dataTransfer, method: "paste" }) } function f() { this.customTitle = a && a.title } var q = !1, g = "auto", k = !1; d || (d = a, a = null); b.on("paste", c, null, null, 0); b.on("beforePaste", function (a) { a.removeListener(); q = !0; g = a.data.type }, null, null, 1E3); !1 === z() && (b.removeListener("paste", c), q && b.fire("pasteDialog",
                f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide", function (a) { a.removeListener(); a.data.removeListener("pasteDialogCommit", e); setTimeout(function () { k || d(null) }, 10) })) : d(null))
            }
        } function A(b) {
            ...
            var a = CKEDITOR.plugins.clipboard; b.on("contentDom", function () {
                ...
                } function d(d, c) { d.select(); r(b, { dataTransfer: c, method: "drop" }, 1); a.resetDragDataTransfer() } function e(a, d, c) { var e = { $: a.data.$, target: a.data.getTarget() }; d && (e.dragRange = d); c && (e.dropRange = c); !1 === b.fire(a.name, e) && a.data.preventDefault() } function g(a) { a.type != CKEDITOR.NODE_ELEMENT && (a = a.getParent()); return a.getChildCount() }
                ...
                f.attachListener(h, "drop", function (d) { if (!d.data.$.defaultPrevented) { d.data.preventDefault(); var c = d.data.getTarget(); if (!c.isReadOnly() || c.type == CKEDITOR.NODE_ELEMENT && c.is("html")) { var c = a.getRangeAtDropPosition(d, b), f = a.dragRange; c && e(d, f, c) } } }, null, null, 9999); f.attachListener(b, "drop", a.initDragDataTransfer, a, null, 1); f.attachListener(b, "drop", function (e) {
                    if (e = e.data) {
                        var f = e.dropRange, g = e.dragRange, h = e.dataTransfer; h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ? setTimeout(function () {
                            a.internalDrop(g,
                            f, h, b)
            ...
            requires: "dialog", init: function (b) {
                var a, c = D(); b.config.forcePasteAsPlainText ? a = "plain-text" : b.config.pasteFilter ? a = b.config.pasteFilter : !CKEDITOR.env.webkit || "pasteFilter" in b.config || (a = "semantic-content"); b.pasteFilter = c.get(a); y(b); F(b); CKEDITOR.dialog.add("paste", CKEDITOR.getUrl(this.path + "dialogs/paste.js")); b.on("paste", function (a) {
                    a.data.dataTransfer ||
                    (a.data.dataTransfer = new CKEDITOR.plugins.clipboard.dataTransfer); if (!a.data.dataValue) { var c = a.data.dataTransfer, g = c.getData("text/html"); if (g) a.data.dataValue = g, a.data.type = "html"; else if (g = c.getData("text/plain")) a.data.dataValue = b.editable().transformPlainTextToHtml(g), a.data.type = "text" }
                    ...
                    function (a, b) { return b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;") })), -1 < b.indexOf('\x3cbr class\x3d"Apple-interchange-newline"\x3e') && (a.data.startsWithEOL = 1, a.data.preSniffing = "html", b = b.replace(/<br class="Apple-interchange-newline">/, "")), b = b.replace(/(<[^>]+) class="Apple-[^"]*"/gi, "$1")); if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                        var f, h, l = new CKEDITOR.dom.element("div"); for (l.setHtml(b) ; 1 == l.getChildCount() && (f = l.getFirst()) && f.type == CKEDITOR.NODE_ELEMENT && (f.hasClass("cke_editable") ||
                    ...
                    a = a.data; var e = a.type, g = a.dataValue, f, h = b.config.clipboard_defaultContentType ||
            ...
            "beforepaste" : "paste", canClipboardApiBeTrusted: function (b, a) { return b.getTransferType(a) != CKEDITOR.DATA_TRANSFER_EXTERNAL || CKEDITOR.env.chrome && !b.isEmpty() || CKEDITOR.env.gecko && (b.getData("text/html") || b.getFilesCount()) ? !0 : !1 }, getDropTarget: function (b) { var a = b.editable(); return CKEDITOR.env.ie && 9 > CKEDITOR.env.version || a.isInline() ? a : b.document }, fixSplitNodesAfterDrop: function (b, a, c, d) {
                ...
                if (this.isCustomCopyCutSupported) {
                    if (b &&
                    b.data && b.data.$) { var c = new this.dataTransfer(b.data.$.clipboardData, a); this.copyCutData && c.id == this.copyCutData.id ? (c = this.copyCutData, c.$ = b.data.$.clipboardData) : this.copyCutData = c; return c } return new this.dataTransfer(null, a)
        ...
        }; var p = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? "cke/id" : "Text"; CKEDITOR.plugins.clipboard.dataTransfer =
        function (b, a) {
            ...
            getData: function (b) {
                b = this._.normalizeType(b); var a = this._.data[b]; if (void 0 === a || null === a || "" === a) try { a = this.$.getData(b) } catch (c) { } if (void 0 === a || null === a || "" === a) a = ""; "text/html" == b ? (a = a.replace(this._.metaRegExp, ""), (b = this._.bodyRegExp.exec(a)) &&
                b.length && (a = b[1], a = a.replace(this._.fragmentRegExp, ""))) : "Text" == b && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 7) && (a = ""); return a
                ...
                function b(b) { b = a._.normalizeType(b); var c = a.getData(b); c && (a._.data[b] = c) } if (this.$) {
                    var a = this, c, d; if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) { if (this.$.types) for (c = 0; c < this.$.types.length; c++) b(this.$.types[c]) } else b("Text"), b("URL"); d = this._getImageFromClipboard(); if (this.$ && this.$.files || d) {
    ...
    (function () {
        ...
        requires: "panelbutton,floatpanel", init: function (d) {
            function r(a, f, c, e, h) {
                var m = new CKEDITOR.style(k["colorButton_" + f + "Style"]), l = CKEDITOR.tools.getNextId() + "_colorBox"; h = h || {}; d.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    label: c, title: c, modes: { wysiwyg: 1 }, editorFocus: 0, toolbar: "colors," + e, allowedContent: m, requiredContent: m, contentTransformations: h.contentTransformations, panel: { css: CKEDITOR.skin.getPath("editor"), attributes: { role: "listbox", "aria-label": g.panelTitle } }, onBlock: function (n,
                    b) { b.autoSize = !0; b.element.addClass("cke_colorblock"); b.element.setHtml(u(n, f, l)); b.element.getDocument().getBody().setStyle("overflow", "hidden"); CKEDITOR.ui.fire("ready", this); var a = b.keys, c = "rtl" == d.lang.dir; a[c ? 37 : 39] = "next"; a[40] = "next"; a[9] = "next"; a[c ? 39 : 37] = "prev"; a[38] = "prev"; a[CKEDITOR.SHIFT + 9] = "prev"; a[32] = "click" }, refresh: function () { d.activeFilter.check(m) || this.setState(CKEDITOR.TRISTATE_DISABLED) }, onOpen: function () {
                        var a = d.getSelection(), a = a && a.getStartElement(), a = d.elementPath(a), b; if (a) {
                            a =
                            a.block || a.blockLimit || d.document.getBody(); do b = a && a.getComputedStyle("back" == f ? "background-color" : "color") || "transparent"; while ("back" == f && "transparent" == b && a && (a = a.getParent())); b && "transparent" != b || (b = "#ffffff"); !1 !== k.colorButton_enableAutomatic && this._.panel._.iframe.getFrameDocument().getById(l).setStyle("background-color", b); return b
                        }
                    }
                })
            } function u(a, f, c) {
                var e = [], h = k.colorButton_colors.split(","), m = d.plugins.colordialog && !1 !== k.colorButton_enableMore, l = h.length + (m ? 2 : 1), n = CKEDITOR.tools.addFunction(function (b,
                c) {
                    function e(a) { this.removeListener("ok", e); this.removeListener("cancel", e); "ok" == a.name && g(this.getContentElement("picker", "selectedColor").getValue(), c) } var g = arguments.callee; if ("?" == b) d.openDialog("colordialog", function () { this.on("ok", e); this.on("cancel", e) }); else {
                        d.focus(); a.hide(); d.fire("saveSnapshot"); d.removeStyle(new CKEDITOR.style(k["colorButton_" + c + "Style"], { color: "inherit" })); if (b) {
                            var f = k["colorButton_" + c + "Style"]; f.childRule = "back" == c ? function (a) { return t(a) } : function (a) {
                                return !(a.is("a") ||
                ...
                c, '"\x3e\x3c/span\x3e\x3c/td\x3e\x3ctd colspan\x3d7 align\x3dcenter\x3e', g.auto, "\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/a\x3e"); e.push('\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e'); for (c = 0; c < h.length; c++) {
                    0 === c % 8 && e.push("\x3c/tr\x3e\x3ctr\x3e"); var b = h[c].split("/"), p = b[0], q = b[1] || p; b[1] || (p = "#" + p.replace(/^(.)(.)(.)$/, "$1$1$2$2$3$3")); b = d.lang.colorbutton.colors[q] || q; e.push('\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"',
                ...
                n, ",'?','", f, "');return false;\" href\x3d\"javascript:void('", g.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', l, '" aria-setsize\x3d"', l, '"\x3e', g.more, "\x3c/a\x3e\x3c/td\x3e"); e.push("\x3c/tr\x3e\x3c/table\x3e"); return e.join("")
            } function t(a) { return "false" == a.getAttribute("contentEditable") || a.getAttribute("data-nostyle") } var k = d.config, g = d.lang.colorbutton; CKEDITOR.env.hc || (r("TextColor", "fore", g.textColorTitle, 10, {
    ...
    (function () {
        ...
        t = CKEDITOR.addTemplate("menuArrow", '\x3cspan class\x3d"cke_menuarrow"\x3e\x3cspan\x3e{label}\x3c/span\x3e\x3c/span\x3e'), n = CKEDITOR.addTemplate("menuShortcut", '\x3cspan class\x3d"cke_menubutton_label cke_menubutton_shortcut"\x3e{shortcut}\x3c/span\x3e'); CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                }), m = d.block.attributes = d.attributes || {}; !m.role && (m.role = "menu"); this._.panelDefinition = d
            }, _: {
                onShow: function () { var a = this.editor.getSelection(), b = a && a.getStartElement(), d = this.editor.elementPath(), m = this._.listeners; this.removeAll(); for (var g = 0; g < m.length; g++) { var k = m[g](b, a, d); if (k) for (var e in k) { var f = this.editor.getMenuItem(e); !f || f.command && !this.editor.getCommand(f.command).state || (f.state = k[e], this.add(f)) } } }, onClick: function (a) {
                    ...
                    var b = this._.subMenu, d = this.items[a]; if (d = d.getItems && d.getItems()) {
                        b ? b.removeAll() : (b = this._.subMenu = new CKEDITOR.menu(this.editor, CKEDITOR.tools.extend({}, this._.definition, { level: this._.level + 1 }, !0)), b.parent = this, b._.onClick = CKEDITOR.tools.bind(this._.onClick, this)); for (var m in d) {
                            var g =
                            this.editor.getMenuItem(m); g && (g.state = d[m], b.add(g))
                        } var k = this._.panel.getBlock(this.id).element.getDocument().getById(this.id + String(a)); setTimeout(function () { b.show(k, 2) }, 0)
                ...
                add: function (a) { a.order || (a.order = this.items.length); this.items.push(a) }, removeAll: function () { this.items = [] }, show: function (a, b, d, m) {
                    if (!this.parent && (this._.onShow(), !this.items.length)) return; b = b || ("rtl" == this.editor.lang.dir ? 2 : 1); var g = this.items, k = this.editor, e = this._.panel, f = this._.element;
                    if (!e) {
            ...
            $: function (a,
            b, d) { CKEDITOR.tools.extend(this, d, { order: 0, className: "cke_menubutton__" + b }); this.group = a._.menuGroups[this.group]; this.editor = a; this.name = b }, proto: {
                render: function (a, b, d) {
                    var h = a.id + String(b), g = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state, k = "", e = this.editor, f, c, l = g == CKEDITOR.TRISTATE_ON ? "on" : g == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off"; this.role in { menuitemcheckbox: 1, menuitemradio: 1 } && (k = ' aria-checked\x3d"' + (g == CKEDITOR.TRISTATE_ON ? "true" : "false") + '"'); var u = this.getItems, q =
                    "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";", p = this.name; this.icon && !/\./.test(this.icon) && (p = this.icon); this.command && (f = e.getCommand(this.command), (f = e.getCommandKeystroke(f)) && (c = CKEDITOR.tools.keystrokeToString(e.lang.common.keyboard, f))); a = {
                        id: h, name: this.name, iconName: p, label: this.label, cls: this.className || "", state: l, hasPopup: u ? "true" : "false", disabled: g == CKEDITOR.TRISTATE_DISABLED, title: this.label + (c ? " (" + c.display + ")" : ""), ariaShortcut: c ? e.lang.common.keyboardShortcut + " " + c.aria :
    ...
    (function () {
        ...
        function n(a, c, k, d, q, n, u, w) {
            var x = a.config, r = new CKEDITOR.style(u), f = q.split(";"); q = []; for (var m = {}, g = 0; g < f.length; g++) { var l = f[g]; if (l) { var l = l.split("/"), v = {}, p = f[g] = l[0]; v[k] = q[g] = l[1] || p; m[p] = new CKEDITOR.style(u, v); m[p]._.definition.name = p } else f.splice(g--, 1) } a.ui.addRichCombo(c, {
                label: d.label, title: d.panelTitle, toolbar: "styles," + w, allowedContent: r, requiredContent: r, contentTransformations: [[{
                ...
                init: function () { this.startGroup(d.panelTitle); for (var b = 0; b < f.length; b++) { var a = f[b]; this.add(a, m[a].buildPreview(), a) } }, onClick: function (b) {
                    a.focus(); a.fire("saveSnapshot"); var c = this.getValue(), k = m[b]; if (c && b != c) {
                        var d = m[c], e = a.getSelection().getRanges()[0]; if (e.collapsed) {
                            var f = a.elementPath(), h = f.contains(function (a) { return d.checkElementRemovable(a) }); if (h) {
                                var g = e.checkBoundaryOfElement(h, CKEDITOR.START), l = e.checkBoundaryOfElement(h, CKEDITOR.END); if (g && l) {
        ...
        } function t(a, c, k) { var d = c.pop(); if (d) { if (k) return t(a, c, d.equals(k) ? null : k); k = d.clone(); a.insertNode(k); a.moveToPosition(k, CKEDITOR.POSITION_AFTER_START); t(a, c) } } CKEDITOR.plugins.add("font", {
            ...
            requires: "richcombo", init: function (c) {
                var l = c.config, g = c.lang.stylescombo, f = {}, k = [], m = []; c.on("stylesSet", function (b) {
                    ...
                    label: g.label, title: g.panelTitle, toolbar: "styles,10", allowedContent: m, panel: { css: [CKEDITOR.skin.getPath("editor")].concat(l.contentsCss), multiSelect: !0, attributes: { "aria-label": g.panelTitle } }, init: function () {
                        ...
                        var b =
                        c.elementPath(); if (b) { for (var a in f) if (f[a].checkApplicable(b, c, c.activeFilter)) return; this.setState(CKEDITOR.TRISTATE_DISABLED) }
                    }, reset: function () { f = {}; k = [] }
                })
            }
        })
